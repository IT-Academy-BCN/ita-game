            ...
            <Modal>
               <div className="flex flex-col">
                  <div className="card-title justify-between">
                     ...
                     <button className="btn btn-circle bg-secondary" onClick={() => setOpenModal(false)}>
                        X
                     </button>
                  </div>
            ...
            <Card>
               ...
               <div className="flex flex-row w-100 justify-center relative mb-20">
                  ...
                  <div className="flex flex-col justify-center items-center absolute ">
                     ...
                     {/* dev position */}
                     <div className="text-neutral-focus font-bold">{user.framework}</div>
                  </div>
                  {/* edit */}
                  <div className="w-1/6 absolute right-0">
                     <button className="btn btn-circle bg-primary" onClick={handleOpenModal}>
                  ...
                  <div className="flex flex-col ">
                     ...
                     <div className="flex justify-between">
                        <div className="flex justify-center">
                           <p className="font-bold text-black text-sm">{user.ITApoints} ITAS</p>
                        </div>
                        <div className="flex justify-center">
                           <p className="font-bold text-black text-sm">{nextMultiple - user.ITApoints}</p>

                           <p className="text-neutral-focus font-bold text-sm">para subir de nivel</p>
                        </div>
                     </div>
                  </div>
               ...
               {fakeUser.ITAawards.map((a) => {
                  return (
                     <Badge
                        classBody={
                           a.name !== 'Imparable'
                              ? 'card-body py-0 px-0 gap-0 items-center text-center'
                              : 'card-body pt-0 pb-6 px-0 gap-0 items-center text-center'
                        }
                        classFigure={a.name !== 'Megamind' ? 'px-2 pt-4' : 'px-2 pt-4 mt-2'}
